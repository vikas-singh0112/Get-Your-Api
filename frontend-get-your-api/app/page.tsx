        ...
        <div className="w-full flex flex-col  text-white">
            ...
            <section className="w-full flex h-[calc(100vh-60px)] px-10 items-center">
                <div className="w-1/2 flex flex-col justify-center gap-6">
                    ...
                    <div className="flex gap-6 mt-4">
                        <CustomButton title="Sign-Up" btnType="primary" className="w-40 h-12 font-semibold" />
                        <CustomButton title="Get Started" btnType="secondary" className="w-40 h-12 font-semibold" />
                    </div>
                </div>

                <div className="w-1/2 p-6 h-[70%]">
                    <div className="border-2 border-green-500/30 shadow-[0_0_50px_-12px_rgba(34,197,94,0.3)] w-full h-full rounded-2xl bg-zinc-900/50"></div>
                </div>
            </section>
            ...
            <section className="w-full bg-zinc-900/50  py-20 px-10 rounded-2xl">
                <div className="w-full text-center mb-10">
                    <h3 className="text-4xl ">What We <span className="underline decoration-green-500 underline-offset-8">Offer</span></h3>
